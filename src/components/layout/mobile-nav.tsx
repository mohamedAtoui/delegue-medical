...
import { ClipboardList, Stethoscope, LayoutDashboard, CalendarCheck, Sparkles, User, Users, Package } from "lucide-react";
...
const allNavItems = [
  ...
  { href: "/assistant", label: "Assistant", icon: Sparkles, roles: ["superviseur"] },
